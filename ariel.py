...
oracle_mode =0
metacache_entries=int(g_params["metacache_entries"])


trace_file = g_params["trace_file"]
...
CacheMemCtrlLink = sst.Link("bus_Mem")
CacheMemCtrlLink.connect((membus, "low_network_0", busLat), (memory, "direct_link", busLat))
...
for core in range (corecount):
   ...
   # Ariel -> L1(PRIVATE) -> L2(PRIVATE)  -> L3 (SHARED) -> DRAM 
    ...
    MemContentLink.connect((ariel, "linkMemContent",busLat), (comp_memhBridge, "contentLink", busLat));
