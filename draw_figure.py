...
id_spec_b   =   "1521758354423"   #8cores, 200M,random-page
id_spec_t   =   "1521758380103"    #8cores, 200M,random-page
...
id_gap_b    =   "1521750278964"   #1thread, 8cores, 200M, F10B, Random
id_gap_t    =   "1521755582092"   #1thread, 8cores, 200M, F10B, Random
...
result_name =   "randomPage"
cores       =   8
per_core_insts = 200000000
total_inst  =   per_core_insts

#L3 MPKI + L3 HIT RATE
db_misses   =   mergeDB("misses","l3",id_base,id_tech)
db_hits      =   mergeDB("hits","l3",id_base,id_tech)
db_accesses =   mergeDB("accesses","l3",id_base,id_tech)
db_l3_mpki  =   db_misses/(total_inst/1000)
db_l3_hitrate       =   db_hits/db_accesses
...
print "\n --- l3 hit rate ---"
print db_l3_hitrate
db_l3_hitrate.plot.bar()
plt.savefig(report_dir+"/l3hitrate-%s.pdf"%(result_name))
'''
...
#metacahe hitrate
db_metacache_hit = getItem_from_multipleDB("memzip_metacache_hit","MemController0",id_tech).iloc[:,1]
db_metacache_miss = getItem_from_multipleDB("memzip_metacache_miss","MemController0",id_tech).iloc[:,1]

#db_metacache_hitrate = db_metacache_hit/(db_metacache_hit+db_metacache_miss)
print "\n ---metacache hit"
print db_metacache_hit
print "\n ---metacache miss"
print db_metacache_miss
