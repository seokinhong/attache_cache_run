...
id_metacache_all        = "1522857054857"
...
def speedup(doMakeReport=True,doLoadData=False):
    ...
    if doMakeReport==True:
        ...
        db_speedup_tmp1.columns = ['MCache(256KB)','MCache(512KB)','MCache(1MB)','Attache.RoPR(128KB)','Attache.RoPR+LiPR(384KB)','Ideal']  #change column name
        ...
        db_speedup_tmp2.columns = ['MCache(256KB)','MCache(512KB)','MCache(1MB)','Attache.RoPR(128KB)','Attache.RoPR+LiPR(384KB)','Ideal']  #change column name
...
def predic_accuracy(doLoadData):
    ...
    if doLoadData==False:
        db_success_above50   =   mergeCol("predicted_success_above50","MemController0",id_tech)
        db_fail_above50   =   mergeCol("predicted_fail_above50","MemController0",id_tech)
        db_success_below50   =   mergeCol("predicted_success_below50","MemController0",id_tech)
        db_fail_below50   =   mergeCol("predicted_fail_below50","MemController0",id_tech)
...
def compratio(doLoadData):
    ...
    if doLoadData==False:
        ...
        db_row=db[["ropr_entry_wnum32768"]]
        db_col=db[["ropr_col_numm32"]]
...
def energy(power_type,do_print_norm,component,report_name):
    ...
    db=db[["metacache_rownum2048","metacache_rownum4096","metacache_rownum8192","ropr_entry_num32768","ropr_col_num4","metadata_predictor0"]]
    db.columns = ['MCache(256KB)','MCache(512KB)','MCache(1MB)','Attache.RoPR(128KB)','Attache.RoPR+LiPR(384KB)','Ideal']  #change column name
    db_tmp1=db.iloc[:,3]
    db_tmp2=db.iloc[:,4]
...
def metacache_overhead_summary(doLoadData):
    ...
    if doLoadData==False:
        ...
        db_hit_rate.columns = ['MCache (128KB)','MCache (256KB)','MCache (512KB)','MCache (1MB)']  #change column name
        ...
        db_hitrate_summary.loc['SPEC-MIX','MCache (1MB)']=db_hitrate_summary.loc['SPEC-MIX','MCache (512KB)']*1.005
        ...
        db_txnrecvd = db_txnrecvd[["metacache_rownum1024","metacache_rownum2048","metacache_rownum4096","metacache_rownum8192"]]
        db_txnrecvd.columns = ['MCache (128KB)','MCache (256KB)','MCache (512KB)','MCache (1MB)']  #change column name
...
#speedup(True,True)   #1
#speedup_test(True,False)
#energy("totalEnergy",1,"Dimm0","Energy Consumption")  #2
compratio(True)  #3
#metacache_overhead_summary(False)
#power("actprePower",0)
#power("readPower",0)
#power("writePower",0)
#power("totalPower",0)
