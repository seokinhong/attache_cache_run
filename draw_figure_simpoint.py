...
id_spec_b   =   "1521998129019"   #8cores, 200M,random-page,sp
id_spec_t   =   "1521998135802"    #8cores, 200M,random-page,sp
...
id_gap_b    =   "1521998144841"   #1thread, 8cores, 200M, F10B, Random
id_gap_t    =   "1521998150225"   #1thread, 8cores, 200M, F10B, Random
...
db_metacache_hit.to_csv(report_dir+"/mcache_hit-%s.csv"%(result_name))
db_metacache_miss.to_csv(report_dir+"/mcache_miss-%s.csv"%(result_name))
